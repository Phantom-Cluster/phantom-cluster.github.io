			...
			<div class="flex items-center justify-between border-b border-neutral-200 pb-5 mb-12 cs-hero-element">
				<div class="relative inline-flex overflow-hidden rounded-full p-[1.5px] shadow-sm bg-neutral-200">
					...
					<div class="inline-flex h-full w-full items-center justify-center rounded-full bg-white px-6 py-2 relative z-10">
						<span class="text-[11px] font-mono tracking-widest text-neutral-500 uppercase">Concept — Fact-Checking News Platform</span>
					</div>
				</div>
				<div class="hidden sm:flex items-center gap-4">
					<a href="https://www.behance.net/gallery/109173469/Alt-News-(Concept-Design)" target="_blank" rel="noopener noreferrer" class="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-[#f59e0b]/40 bg-[#f59e0b]/5 text-[9px] font-mono tracking-widest text-[#fbbf24] uppercase hover:border-[#f59e0b]/70 hover:bg-[#f59e0b]/10 transition-colors">Behance ↗</a>
			...
			<div class="flex items-start gap-10 cs-hero-element">
				<div class="flex-1 min-w-0">
					...
					<h1 class="text-[clamp(3rem,8vw,7.5rem)] font-black tracking-tight leading-[0.9] text-neutral-900">
						Truth<br/>
						<span class="text-neutral-300">Before</span><br/>
						The&nbsp;Click.
					</h1>
				...
				<div class="shrink-0 w-56 hidden md:flex flex-col gap-6 pt-14">
					...
					<div>
						...
						<span class="text-sm font-semibold text-neutral-800">Web / News Platform</span>
					</div>
					<div>
					...
					<div class="pt-5 border-t border-neutral-100">
						<a href="https://www.behance.net/gallery/109173469/Alt-News-(Concept-Design)" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-portfolio-accent hover:underline">
			...
			<div class="max-w-7xl mx-auto">
				...
				<div class="grid grid-cols-1 lg:grid-cols-12 gap-5 mb-5">
					<div class="lg:col-span-8 bg-neutral-950 rounded-4xl p-10 lg:p-14 border border-white/5 flex flex-col justify-between cs-fade-up">
						<p class="text-[11px] font-mono tracking-widest text-primary uppercase mb-8">{project.role} · News Platform Concept</p>
						<h2 class="text-3xl lg:text-5xl font-black tracking-tight text-white leading-[1.05]">
							A <span class="text-shimmer-white">credibility-first reading interface</span> — verification status foregrounded before the headline is read.
						</h2>
					</div>
