			...
			<div class="flex items-center justify-between border-b border-neutral-200 pb-5 mb-12 cs-hero-element">
				<div class="relative inline-flex overflow-hidden rounded-full p-[1.5px] shadow-sm bg-neutral-200">
					...
					<div class="inline-flex h-full w-full items-center justify-center rounded-full bg-white px-6 py-2 relative z-10">
						<span class="text-[11px] font-mono tracking-widest text-neutral-500 uppercase">Concept — Focus-First Productivity App</span>
					</div>
				</div>
				<div class="hidden sm:flex items-center gap-4">
					<a href="https://www.behance.net/gallery/114922057/Effido-(Productivity-App)" target="_blank" rel="noopener noreferrer" class="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-[#10b981]/40 bg-[#10b981]/5 text-[9px] font-mono tracking-widest text-[#10b981] uppercase hover:border-[#10b981]/70 hover:bg-[#10b981]/10 transition-colors">Behance ↗</a>
			...
			<div class="flex items-start gap-10 cs-hero-element">
				...
				<div class="shrink-0 w-56 hidden md:flex flex-col gap-6 pt-14">
					...
					<div>
						...
						<span class="text-sm font-semibold text-neutral-800">Mobile App (iOS / Android)</span>
					</div>
					<div>
			...
			<div class="max-w-7xl mx-auto">
				...
				<div class="grid grid-cols-1 lg:grid-cols-12 gap-5 mb-5">
					<div class="lg:col-span-8 bg-neutral-950 rounded-4xl p-10 lg:p-14 border border-white/5 flex flex-col justify-between cs-fade-up">
						<p class="text-[11px] font-mono tracking-widest text-primary uppercase mb-8">{project.role} · Mobile App Concept</p>
						<h2 class="text-3xl lg:text-5xl font-black tracking-tight text-white leading-[1.05]">
							A <span class="text-shimmer-white">focus-first task model</span> — fewer visible tasks, deeper context, no inbox anxiety.
						</h2>
					</div>
