...
<section class="w-full bg-white pt-24 pb-20 overflow-x-hidden">
	<div class="max-w-6xl mx-auto px-4 md:px-6">
		...
		<p class="text-[10px] font-mono tracking-[0.35em] text-neutral-400 uppercase mb-4">Performance Optimization</p>
		<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-12">
			<h2 class="text-[clamp(2.4rem,6vw,4.5rem)] font-black tracking-tight text-gray-900 leading-none">
				Critical.<br/>
				<span class="text-neutral-300">Fast.</span><br/>
				Clean.
			</h2>
		...
		<div class="grid grid-cols-1 md:grid-cols-[1fr_1fr_1.6fr] border-t border-b border-gray-200 mb-0">
			...
			<div class="py-10 md:pr-10 md:border-r border-gray-200 border-b md:border-b-0 flex flex-col justify-between">
				<span class="text-[10px] font-mono tracking-[0.18em] text-gray-400 uppercase block mb-4">Page Load Speed</span>
				<div>
					<div class="flex items-baseline leading-none mb-3">
						<span class="text-[clamp(2.5rem,7vw,4.5rem)] font-black text-neutral-300 tracking-tighter leading-none line-through decoration-[#FF4400]/60">5–6s</span>
						<span class="text-[#FF4400] font-black text-[clamp(1.8rem,5vw,3rem)] mx-2 leading-none">→</span>
						<span class="text-glow text-[clamp(2.5rem,7vw,4.5rem)] font-black text-[#FF4400] tracking-tighter leading-none">&lt;1s</span>
					</div>
			...
			<div class="py-10 md:px-10 md:border-r border-gray-200 border-b md:border-b-0 flex flex-col justify-between">
				<span class="text-[10px] font-mono tracking-[0.18em] text-gray-400 uppercase block mb-4">Performance Gain</span>
				<div>
					<div class="flex items-baseline leading-none mb-3">
						<span class="text-[clamp(4rem,10vw,6.5rem)] font-black text-[#FF4400] tracking-tighter leading-none">75</span>
			...
			<div class="relative overflow-hidden rounded-2xl bg-black group"
				...
				<div class="absolute bottom-5 inset-x-5 flex flex-col gap-3 px-5 py-4 rounded-2xl
					...
					<div class="flex items-center gap-4 w-full">
						...
						<input type="range" min="0" max={duration1 || 100} step="0.01" bind:value={currentTime1}
					...
					<div class="flex items-center justify-between w-full">
						<div class="flex items-center gap-6">
							<button onclick={back1} class="text-white/80 hover:text-white transition-colors flex items-center gap-1 group/btn">
							...
							<button onclick={toggle1} class="w-10 h-10 rounded-full bg-white text-black flex items-center justify-center hover:scale-105 active:scale-95 transition-all">
								{#if isPaused1}
							...
							<button onclick={fwd1} class="text-white/80 hover:text-white transition-colors flex items-center gap-1 group/btn">
						...
						<button onclick={() => toggleFullScreen(wrapper1El)} class="text-white/80 hover:text-white transition-colors">
				...
				<div class="grid grid-cols-1 md:grid-cols-[1.4fr_1fr] gap-10">
					<div class="flex flex-col justify-between gap-6">
						...
						<p class="text-[clamp(1.3rem,3.2vw,2rem)] font-black text-white leading-snug">
							...
							They were failing at <span class="text-[#FF4400]">trust.</span>
						</p>
					...
					<div class="relative overflow-hidden rounded-2xl bg-black group"
						...
						<div class="absolute bottom-4 inset-x-4 flex flex-col gap-3 px-4 py-3.5 rounded-2xl
							...
							<div class="flex items-center justify-between w-full">
								...
								<button onclick={() => toggleFullScreen(wrapper2El)} class="text-white/80 hover:text-white transition-colors">
					...
					<div class="relative overflow-hidden rounded-2xl bg-black group"
						...
						<div class="absolute bottom-4 inset-x-4 flex flex-col gap-3 px-4 py-3.5 rounded-2xl
							...
							<div class="flex items-center justify-between w-full">
								...
								<button onclick={() => toggleFullScreen(wrapper3El)} class="text-white/80 hover:text-white transition-colors">
									<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4"/></svg>
								</button>
							</div>
						</div>
